classdef WaterGasHybridModel_FF < TwoPhaseFluidFlowerModel % < GenericBlackOilModel
    ...
    methods
        ...
        function model = WaterGasHybridModel_FF(G, rock, fluid, varargin)
            opt = struct('sealingFaces', [], 'sealingCells', [], 'p_entry', 0);
            ...
            model.fluid.p_entry = opt.p_entry;
