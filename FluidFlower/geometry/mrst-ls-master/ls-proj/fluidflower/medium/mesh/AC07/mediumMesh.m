...
plotLinePath(meshpt.lines(5:end-1), 'b');
plotLinePath([meshpt.lines(1:4) meshpt.lines(end)], 'r');
...
%f = 1/L(1);
%cellSize  = [4*f 4*f]*1e-3; % f f will give 4mm after rescaling [xSize, ySize], in m
