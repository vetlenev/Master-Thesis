...
Nstrat = numel(vcl);
gridRes = repmat([0.5, 5; 0.25, 2.5; 0.1, 1; 0.05, 0.5; ...
                  0.025, 0.25; 0.01, 0.1], 1, 1, Nstrat);         
Ngrid = size(gridRes, 1);
poro  = zeros(Ngrid, Nstrat);
perm  = zeros(Ngrid, 3, Nstrat);
cellDim = zeros(Ngrid, 2, Nstrat);
seedNum = randi(10000, 1, Nstrat);
%seedNum = [7194 4214 5419 9413 546];
