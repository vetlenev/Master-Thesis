...
%               in the fluid structure as f.krGib. Currently, this
%               can be obtained from assignSGFN (keyword SGFN in ECLIPSE
...
for n = 1:nregi
    ...
    kri{n}  = @(sg, sgi) scanRelPerm(sg, sgi, kriVars, f.ehystr);
end
f.krGi   = kri;

% ----------------- Compute Scanning kr curve --------------------
    function [kri, tol, minSat, sgt] = scanRelPerm(sg, sgi, kriVars, opts)
