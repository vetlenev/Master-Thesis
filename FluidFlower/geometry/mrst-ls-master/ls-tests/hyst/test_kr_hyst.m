...
%fn   = 'mrst-2019b/mytests/punq-s3/CASE2.DATA';       % 1 imb region
%fn   = 'mrst-2019b/mytests/punq-s3/CASE2_regi.DATA';   % 2 imb region

%fn   = 'mrst-dev/mrst-ls/ls-tests/hyst/punq-s3/CASE1.DATA';       % no hyst
%fn   = 'mrst-dev/mrst-ls/ls-tests/hyst/punq-s3/CASE2.DATA';       % 1 imb region
...
if strcmp(fn, 'mrst-dev/mrst-ls/ls-tests/hyst/punq-s3/CASE2_regi.DATA')
