...
% Define regions
id_seal = G.cells.centroids(:,3) < 200; % i.e. top "seal" layer
...
%fn = 'C:\Users\lsalo\matlab\mrst-2019a\myprojects\2.5Dtestmesh\eclipse_data_files\ftest_co2brine.DATA';
fn = 'myprojects/2.5Dtestmesh/eclipse_data_files/ftest_co2brine.DATA';
...
%% Correct Pore Volume and Assign model (Two phase live oil - dry gas)
% Pore volume
...
model.operators.p0 = p0;                                                    % Needed for MyPvMult
model.FlowPropertyFunctions = MyFlowPropertyFunctions(model);               % Use MyPvMult
