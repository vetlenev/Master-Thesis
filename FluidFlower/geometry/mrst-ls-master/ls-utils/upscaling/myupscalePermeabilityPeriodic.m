function perm = myupscalePermeabilityPeriodic(Gp, bcp, dp_scale, psolver, fluid, L)
% LS this is a copy of upscalePermeabilityPeriodic.m without rock as input
% argument, since it seems unnecessary.
...
for i=1:d
    ...
    state  = psolver(state,Gp,fluid,bcp_new);
