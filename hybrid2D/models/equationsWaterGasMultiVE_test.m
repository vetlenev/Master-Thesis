function [problem, state] = equationsWaterGasMultiVE_test(model, state0, state, dt, drivingForces, varargin)
%{
...
%}
    ...
    [vW, vG, mobW, mobG, upcw, upcg] = computeHybridFluxesVEpc(model, pW, sG, muW, muG, rhoW, rhoG, trans);
    % ---------------------
