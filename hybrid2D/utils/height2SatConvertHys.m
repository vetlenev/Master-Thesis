function [sG, h, h_max, c_VE_Not] = height2SatConvertHys(model, h_func, h_max_func, Sn, snMax, vG, ii)
    ...
    [c_VE_Not, c_VE] = getResidualFilledCellsHys(model, Sn, vG); % coarse saturation Sn, not fine saturation sG
