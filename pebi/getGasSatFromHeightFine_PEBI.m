function [a_Mob, a_R, sG] = getGasSatFromHeightFine_PEBI(model, sg, T, t, B, b, h, h_T, h_B, swr, snr, varargin)
    p = model.G.partition;
    ...
    sG(isFine) = sg(isFine); % fine cellshave already calculated saturation
end