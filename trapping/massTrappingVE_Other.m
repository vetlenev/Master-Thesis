function [masses, masses_0] = massTrappingVE_Other(Gh, cVE, cVE_h, p, sG, sW, h, h_max, ...
...
% PARAMETERS:
%   Gh         - hybrid grid
%   cVE        - desired cells with indices from fine grid
...
%}
    ...
    ct_hybrid_z = Gh.cells.topDepth(cVE_h);   
