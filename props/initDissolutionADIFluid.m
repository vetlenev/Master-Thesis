function fluid = initDissolutionADIFluid(varargin)
...
%
%   dissolution - (true/false) whether to include dissolution of CO2 in brine
%                 or not.
%
% RETURNS:
...
opt = struct('mu',       [], ...
             ...
             'cR',       [], ...
             'dissolution', false, ...
             'dis_rate', 5e-11, ... % 0 => instantaneous dissolution
             'dis_max', 0.03, ...
             'blackoil', true, ...
             'smin',     [0 0 0], ...
             'phases',   'WOG');
