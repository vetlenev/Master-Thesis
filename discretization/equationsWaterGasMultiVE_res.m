...
%}
    ...
    [vW, vG, mobW, mobG, upcw, upcg, ...
        h, h_T, h_B, cellsBH, hHi_state, hBHi_state] = computeHybridFluxesVEres_test(model, pW, sG, muW, muG, rhoW, rhoG, trans, sgMax, state0.vGsum, state0.vGsum_sMax, cB, veB, cH, veH);
