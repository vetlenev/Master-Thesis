classdef WaterGasHybridModel_test < TwoPhaseFluidFlowerModel
    ...
    methods
        ...
        function model = WaterGasHybridModel_test(G, rock, fluid, varargin)
        ...
        function [problem, state] = getEquations(model, state0, state, dt, ...
                drivingForces, ...
                varargin)
            [problem, state] = equationsWaterGasHybrid_test(model, state0, state , dt , ...
                drivingForces, ...
                varargin{:});
        end       
