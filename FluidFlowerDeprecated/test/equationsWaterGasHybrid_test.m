function [problem, state] = equationsWaterGasHybrid_test(model, state0, state, dt, drivingForces, varargin)
%{
...
%}
    ...
    [vW, vG, mobW, mobG, upcw, upcg] = computeHybridFluxes_test(model, pW, sG, muW, muG, rhoW, rhoG, trans, sgMax);
