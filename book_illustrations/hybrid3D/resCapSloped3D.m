...
if useFaceConstraint
    plot_dir = strcat(rootdir, '../Master-Thesis/book_illustrations/hybrid3D/test/figs/face_complex_res/');   
else
    plot_dir = strcat(rootdir, '../Master-Thesis/book_illustrations/hybrid3D/test/figs/cell_complex_res/');
end
mkdir(plot_dir);
